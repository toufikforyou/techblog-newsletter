...
@section('description', 'Join 50,000+ developers receiving the latest insights on software engineering, system
architecture, and emerging tech trends.')
...
<div class="bg-slate-900 py-20 md:py-28 overflow-hidden relative">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="max-w-2xl">
                <div
                    class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-sm font-medium border border-blue-500/20 mb-8">
                ...
                <h1 class="text-5xl md:text-6xl font-bold tracking-tight text-white mb-6 leading-[1.1]">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">tech
                        curve</span>
                </h1>

                <p class="text-lg md:text-xl text-slate-400 mb-10 leading-relaxed max-w-lg">
                    Join 50,000+ developers, engineers, and tech leaders who rely on TechNews for their weekly industry
                    insights.
                </p>

                <!-- Subscription Form -->
                <form id="heroSubForm" class="max-w-md mb-8">
                    @csrf
                    <div class="flex flex-col sm:flex-row gap-3 mb-3">
                        <input type="email" name="email" placeholder="Enter your email address"
                            ...
                            required />
                        <button type="submit" id="heroSubBtn"
                            class="bg-blue-600 hover:bg-blue-500 text-white font-medium py-3 px-6 rounded-lg transition-colors shadow-lg shadow-blue-500/20 whitespace-nowrap w-full sm:w-auto">
                            Subscribe Free
                        </button>
                    </div>
            ...
            <div class="relative hidden lg:block">
                ...
                <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-64 h-64 bg-cyan-500/20 rounded-full blur-3xl">
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="grid grid-cols-2 gap-8">
                        ...
                        <div class="relative top-12">
                            <div
                                class="w-48 h-48 bg-slate-800 border-2 border-blue-500/30 rounded-full overflow-hidden relative shadow-2xl shadow-blue-900/20">
                                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
                                    alt="Developer"
                                    class="w-full h-full object-cover opacity-90 hover:scale-110 transition-transform duration-700">
                            </div>
                            <!-- Speech Bubble -->
                            <div
                                class="absolute -top-8 -right-8 bg-slate-800 border border-slate-700 rounded-2xl rounded-bl-none p-4 shadow-xl">
                        ...
                        <div class="relative">
                            <div
                                class="w-40 h-40 bg-slate-800 border-2 border-cyan-500/30 rounded-full overflow-hidden relative ml-auto shadow-2xl shadow-cyan-900/20">
                            ...
                            <!-- Speech Bubble -->
                            <div
                                class="absolute -top-6 -left-6 bg-slate-800 border border-slate-700 rounded-2xl rounded-br-none p-4 shadow-xl">
                        ...
                        <div class="relative col-span-2 flex justify-center -mt-8">
                            <div class="relative">
                                <div
                                    class="w-56 h-56 bg-slate-800 border-2 border-sky-500/30 rounded-full overflow-hidden relative shadow-2xl shadow-sky-900/20">
                                    <img src="toufik.jpg" alt="CTO"
                                        class="w-full h-full object-cover opacity-90 hover:scale-110 transition-transform duration-700">
                                </div>
                                <!-- Speech Bubble -->
                                <div
                                    class="absolute -bottom-4 -right-4 bg-slate-800 border border-slate-700 rounded-2xl rounded-tl-none p-4 shadow-xl">
        ...
        <div class="grid md:grid-cols-3 gap-12">
            ...
            <div class="space-y-4">
                ...
                <p class="text-slate-600 leading-relaxed">
                    Don't miss a beat. We aggregate breaking news from Silicon Valley to open source communities
                    worldwide.
                </p>
            </div>
            <!-- Feature 2 -->
            <div class="space-y-4">
                ...
                <p class="text-slate-600 leading-relaxed">
                    From AI and Machine Learning to Web3 and Quantum Computing, we cover the innovations shaping the
                    future.
                </p>
            </div>
            <!-- Feature 3 -->
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                ...
                <p class="text-slate-600">"The only source I need to stay on top of the rapidly changing tech landscape.
                    Essential reading."</p>
            </div>
            <!-- Testimonial 2 -->
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                <div class="flex items-center gap-4 mb-4">
                    <div
                        class="h-10 w-10 rounded-full bg-cyan-100 flex items-center justify-center text-cyan-600 font-bold">
                        SJ</div>
                    <div>
                ...
                <p class="text-slate-600">"I love the deep dives into new technologies. It helps me make better
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                <div class="flex items-center gap-4 mb-4">
                    <div
                        class="h-10 w-10 rounded-full bg-sky-100 flex items-center justify-center text-sky-600 font-bold">
                        MP</div>
                    <div>
                ...
                <p class="text-slate-600">"Finally, a tech news site that cuts through the noise and delivers actual
                    value. Highly recommended."</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="relative">
            ...
            <div class="grid md:grid-cols-3 gap-12 relative z-10">
                ...
                <div class="bg-white p-6 text-center">
                    <div
                        class="w-16 h-16 mx-auto bg-blue-600 rounded-2xl flex items-center justify-center text-white text-2xl font-bold mb-6 shadow-lg shadow-blue-200">
                        1</div>
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Global Monitoring</h3>
                    <p class="text-slate-600">We track hundreds of tech news outlets, GitHub repositories, and developer
                        forums 24/7.</p>
                </div>
                <!-- Step 2 -->
                <div class="bg-white p-6 text-center">
                    <div
                        class="w-16 h-16 mx-auto bg-cyan-600 rounded-2xl flex items-center justify-center text-white text-2xl font-bold mb-6 shadow-lg shadow-cyan-200">
                        2</div>
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Expert Analysis</h3>
                    <p class="text-slate-600">Our senior editors verify facts and provide context to help you understand
                        the impact.</p>
                </div>
                <!-- Step 3 -->
                <div class="bg-white p-6 text-center">
                    <div
                        class="w-16 h-16 mx-auto bg-sky-600 rounded-2xl flex items-center justify-center text-white text-2xl font-bold mb-6 shadow-lg shadow-sky-200">
                        3</div>
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Weekly Briefing</h3>
                    <p class="text-slate-600">We compile the most critical updates into a concise, easy-to-read format
                        for you.</p>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="{{ route('blog.show', $blog->slug) }}"
                class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all border border-slate-100 flex flex-col h-full">
                <div class="h-48 bg-slate-200 relative overflow-hidden">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1"
                            stroke="currentColor" class="w-16 h-16 text-white/30">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    @endif
                    <div
                        class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-blue-600 uppercase tracking-wider">
            ...
            <div class="col-span-full py-12 text-center">
                ...
                <a href="{{ route('blog.index') }}"
                    class="text-blue-600 hover:text-blue-700 text-sm font-semibold mt-2 inline-flex items-center gap-1">View
                    blog
...
<section class="py-20 bg-slate-900">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <p class="text-blue-200 text-lg mb-10 max-w-2xl mx-auto">Join the fastest-growing community of tech
            professionals and get your weekly news briefing.</p>
        <form id="bottomCtaForm" class="max-w-md mx-auto space-y-3">
            @csrf
            <div class="relative flex items-center bg-white/10 rounded-xl p-2 ring-1 ring-white/20 backdrop-blur-sm">
                <input type="email" name="email" placeholder="Enter your email address"
                    ...
                    required />
                <button type="submit" id="bottomCtaBtn"
            ...
            <div class="flex justify-center">
                <div class="cf-turnstile" data-sitekey="{{ config('services.turnstile.site_key') }}" data-theme="dark">
                </div>
            </div>
        </form>
...
<script>
    // Initialize hero subscription form
    initSubscriptionForm({
        formId: 'heroSubForm',
        buttonId: 'heroSubBtn',
        messageId: 'heroSubMsg',
        apiUrl: '{{ route("subscribe.store") }}',
        loadingText: 'Subscribing...',
        theme: 'dark'
    });

    // Initialize bottom CTA subscription form
    initSubscriptionForm({
        formId: 'bottomCtaForm',
        buttonId: 'bottomCtaBtn',
        messageId: 'bottomCtaMsg',
        apiUrl: '{{ route("subscribe.store") }}',
        loadingText: 'Subscribing...',
        theme: 'dark'
    });
