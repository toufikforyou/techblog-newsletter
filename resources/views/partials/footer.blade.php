<footer class="bg-slate-900 text-slate-300 py-16 border-t border-slate-800">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div class="col-span-1 md:col-span-1">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="https://github.com/toufikforyou/techblog-newsletter" target="_blank"
                        class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
            ...
            <div>
                ...
                <form id="footerSubForm" class="space-y-3">
                    ...
                    <input type="email" name="email" placeholder="Enter your email"
                        ...
                        required>
                    <button type="submit"
                        class="w-full px-4 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold transition-colors shadow-lg shadow-blue-900/20"
                        id="footerSubBtn">Subscribe</button>
        ...
        <div
            class="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
        ...
        footerForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    footerMsg.classList.remove('text-amber-100', 'bg-amber-600/30', 'text-red-100',
                        'bg-red-600/30');
                    footerForm.reset();
                    setTimeout(() => {
                    ...
                    footerMsg.classList.remove('text-green-100', 'bg-green-600/30', 'text-red-100',
                        'bg-red-600/30');
                    footerBtn.textContent = 'Subscribe';
                    footerBtn.disabled = false;
                    setTimeout(() => {
                ...
                footerMsg.classList.remove('text-green-100', 'bg-green-600/30', 'text-amber-100',
                    'bg-amber-600/30');
