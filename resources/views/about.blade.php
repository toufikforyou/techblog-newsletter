    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid md:grid-cols-2 gap-16 items-center">
            <div class="space-y-6">
                ...
                <p class="text-lg text-slate-600 leading-relaxed">
                    Our team of experienced editors and engineers handpick articles, research papers, and industry
                    updates that
            ...
            <div class="relative">
                ...
                <div class="relative bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-12 space-y-6">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-16 h-16 bg-sky-600 rounded-xl flex items-center justify-center text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-8 h-8">
                                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 text-center">
                <div class="w-24 h-24 mx-auto bg-slate-200 rounded-full mb-4 overflow-hidden">
                    <img src="toufik.png" alt="Project Manager & Lead Backend Engineer"
                        class="w-full h-full object-cover" />
                </div>
                <h3 class="text-xl font-bold text-slate-900">MH TOUFIK</h3>
                <p class="text-blue-600 font-medium mb-2">Project Manager & Lead Backend Engineer</p>
                <p class="text-slate-600 text-sm">
                    Oversees system architecture, async queue implementation, and backend routing.
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 text-center">
                <div class="w-24 h-24 mx-auto bg-slate-200 rounded-full mb-4 overflow-hidden">
                    <img src="siam.png" alt="Team Member" class="w-full h-full object-cover" />
                </div>
                <h3 class="text-xl font-bold text-slate-900">Shiam Mahmud</h3>
                <p class="text-cyan-600 font-medium mb-2">DBA & Security Lead</p>
                <p class="text-slate-600 text-sm">
                    Manages MySQL schema, server configs (Nginx/Apache), and security testing.
                </p>
            </div>
            <!-- Team Member 3 -->
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 text-center">
                <div class="w-24 h-24 mx-auto bg-slate-200 rounded-full mb-4 overflow-hidden">
                    <img src="nasfim.png" alt="Team Member" class="w-full h-full object-cover" />
                </div>
                <h3 class="text-xl font-bold text-slate-900">Nasfim Afrin Tishi</h3>
                <p class="text-sky-600 font-medium mb-2">Frontend Developer</p>
                <p class="text-slate-600 text-sm">
                    Develops the frontend using Tailwind CSS and manages initial tech content.
                </p>
            </div>
            <!-- Team Member 4 -->
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 text-center">
                <div class="w-24 h-24 mx-auto bg-slate-200 rounded-full mb-4 overflow-hidden">
                    <img src="mahi.png" alt="Team Member" class="w-full h-full object-cover" />
                </div>
                <h3 class="text-xl font-bold text-slate-900">Jannatul Mawya Mahia</h3>
                <p class="text-sky-600 font-medium mb-2">QA Tester & Doc Specialist</p>
                <p class="text-slate-600 text-sm">
                    Manages Pest PHP testing and finalizes project documentation.
                </p>
            </div>
        </div>
    </div>
